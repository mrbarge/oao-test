...
import (
	...
	oaov1alpha1 "github.com/mrbarge/ocm-agent-operator/pkg/apis/oao/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileOcmAgent{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &oaov1alpha1.OcmAgent{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner OcmAgent
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &oaov1alpha1.OcmAgent{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileOcmAgent) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling OcmAgent")

	// Fetch the OcmAgent instance
	instance := &oaov1alpha1.OcmAgent{}
	...
	// Set OcmAgent instance as the owner and controller
...
func newPodForCR(cr *oaov1alpha1.OcmAgent) *corev1.Pod {
